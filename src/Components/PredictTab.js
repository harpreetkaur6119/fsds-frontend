        ...
        <div className="container-fluid">
          <div className="row">
            {/* <form id="predictSetup" name="predictForm" onSubmit={this.onSubmit}> */}
              <div className="center-align">
                ...
                <input id="infileid" type="file" ref="file" onChange={this.filepickerHandler} />
              </div>
          ...
          <div className="row center-align l-top-space">
            <div className="inlineBlock col-lg-6 col-md-6 col-sm-6">
              <img align="right" className={this.state.image.length ? 'img-visible' : 'not-visible'} src={this.state.image} alt="loaded for prediction" />
            </div>
            <div className="inlineBlock col-lg-6 col-md-6 col-sm-6">
